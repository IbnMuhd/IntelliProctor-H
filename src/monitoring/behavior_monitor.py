...
class BehaviorMonitor:
    def __init__(self, registered_embedding, frame_skip=2, identity_threshold=0.45):
        ...
        """
        Initialize behavior monitoring and identity verification
        """
        self.frame_count = 0
        ...
        # Pose estimation for phone usage detection
        ...
        # Store last results to reduce CPU load
        self.last_results = {
            "looking_away": False,
    ...
    def analyze_frame(self, frame):
        ...
        frame = resize_frame(frame, width=480)  # reduce size for performance
        ...
        # Pose check only every 10 frames
    ...
    def _verify_identity(self, frame):
        """
        Compare live face embedding with registered embedding using cosine similarity
        """
        ...
        for face in faces:
            ...
            if similarity > (1 - self.identity_threshold):  # cosine similarity: higher is better
                return True
        return False
